...
app.get(`/`, function (req, res) {
	res.render(`home`, { homeContent: homeStartContent, newPosts: posts });
});
...
app.get(`/post/:postName`, function (req, res) {
	...
	posts.forEach(function (post) {
		const y = _.lowerCase(post.userTitle);

		if (x === y) {
			res.render(`post`, {
				postTitle: post.userTitle,
...
// 		let y = _.lowerCase(posts[i].userTitle);
// 		console.log(y);
// 		if (y === x) {
